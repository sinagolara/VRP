# -*- coding: utf-8 -*-
"""
VRP Algorithm: part 1 - Simulaten Annealing
"""
...
try: os.chdir("C:\\Users\\sinag\\Dropbox\\15- Sonae Project\\VRP Analysis")
except: os.chdir("C:\\Users\\sgolara.ASURITE.000\\Dropbox\\15- Sonae Project\\VRP Analysis")
...
def cost1(solution_mtx):
    ...
    if NOrders/NRoutes<4: NTrucks=100
     ...
     #for now do not deal with Truck number
...
#==============================================================================
#     for m in customers:
#         if successor(arcs_new,m)=='':
#             print 'bad relocation.',i,'->',j
#             #network(arcs_mtx)
#             #network(arcs_new)
#         #predecessor(arcs_new,m)
#==============================================================================
...
#arcs.columns
#network(arcs) # Social Network



# <codecell>    
# Neighborhood: Construct neighborhood by relocating NS customers
#print '\n'*100

#network(arcs)
#random.choice(customers, 1)
...
def neighborhood(arcs_mtx,size):
    ...
    #    if feasible(solution(relocated)):
        print '.',
...
#relocate(arcs,1008,1000)
#int(arcs)
#map(numpy.sum,[arcs,arcs])
...
#            if no_improvement>2: l=l+neighborhood(current_arcs, NSize)
            ...
            if len(l)==0: 
                ...
                empty_counter+=1
                continue
            #print 'Neighborhood obtained. size=', len(l)
